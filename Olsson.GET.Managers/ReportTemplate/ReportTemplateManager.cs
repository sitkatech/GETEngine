...
namespace Olsson.GET.Managers.ReportTemplate
{
    internal class ReportTemplateManager : BaseManager, IReportTemplateManager
    {
        ...
        {
            Logger.Information($"Creating report template {displayName}");
        ...
        {
            Logger.Information($"Finding all report templates");
        ...
        {
            Logger.Information($"Finding all report templates for customer with ID:{customerID}");
        ...
        {
            Logger.Information($"Checking for report template with display name {displayName}");
        ...
        {
            Logger.Information($"Deleting report template {id}");
        ...
        {
            Logger.Information($"Finding report template {id}");
        ...
        {
            Logger.Information($"Updating report template {id}");
        ...
        {
            Logger.Information($"Replacing file resource for report template {reportTemplate.ReportTemplateID}");
        ...
        {
            Logger.Information($"Updating configuration for report template {id}");
        ...
        {
            Logger.Information($"Getting RCMS for report template {id}");
        ...
        {
            Logger.Information($"Finding report templates for action {run.RunID}");
