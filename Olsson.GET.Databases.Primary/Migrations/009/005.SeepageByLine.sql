...
INSERT INTO [dbo].[Images] (Id, [Name], [Server], IsLinux, CpuCoreCount, Memory)
	VALUES(
		@ImageId, 
		'seepagebyline',  --This is the name for the image
...
INSERT INTO [dbo].[Scenarios] (Id, [Name], InputControlType, ShouldSwitchSign, InputImageId)
	VALUES (
		...
		'Adjust Seepage by GIS Line', --This is the name for the scenario
...
INSERT INTO [dbo].[ScenarioFiles] (Id, [ScenarioId], [Name], [Description], [Required])
	VALUES (
		...
		@ScenarioId,
		'Seepage_Reduction_Acre-Feet.csv', --The file and extension
...
INSERT INTO [dbo].[ScenarioFiles] (Id, [ScenarioId], [Name], [Description], [Required])
	VALUES (
		(SELECT ISNULL(MAX(Id),0)+1 FROM [dbo].ScenarioFiles), --Don't touch.
		@ScenarioId,
		'SeepageLines.shp', --The file and extension
...
INSERT INTO [dbo].[ScenarioFiles] (Id, [ScenarioId], [Name], [Description], [Required])
	VALUES (
		(SELECT ISNULL(MAX(Id),0)+1 FROM [dbo].ScenarioFiles), --Don't touch.
		@ScenarioId,
		'SeepageLines.shx', --The file and extension
...
INSERT INTO [dbo].[ScenarioFiles] (Id, [ScenarioId], [Name], [Description], [Required])
	VALUES (
		(SELECT ISNULL(MAX(Id),0)+1 FROM [dbo].ScenarioFiles), --Don't touch.
		@ScenarioId,
		'SeepageLines.dbf', --The file and extension
		'.shx file with zones', --The file description, if any
		1 --Set to 1 if the file is required in order to start a run
	)
...
INSERT INTO [dbo].[ScenarioFiles] (Id, [ScenarioId], [Name], [Description], [Required])
	VALUES (
		(SELECT ISNULL(MAX(Id),0)+1 FROM [dbo].ScenarioFiles), --Don't touch.
		@ScenarioId,
		'SeepageLines.prj', --The file and extension
