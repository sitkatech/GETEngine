...
----- Set These Values -----
SET @modelName = 'ELM - Phase II';
----- End Values to Set -----


----- DO NOT CHANGE -----
exec dbo.RetrieveModel @modelName, @imageName OUT, @startDateTime OUT, @modflowExeName OUT, @namFileName OUT, @runFileName OUT, @mapRunFileName OUT, @mapSettings OUT, @mapModelArea OUT, @zoneBudgetExeName OUT, @isDoubleSizeHeatMapOutput OUT, @allowablePercentDiscrepancy OUT, @mapZone OUT, @numberOfStressPeriods out, @canalData out, @modPathExeName out, @simulationFileName out ;
-------------------------
...
set @canalData = 'Burwell-Sumter,Elba,Farwell Central,Farwell Main,Farwell South,Fullerton,Fullerton Canal,Geranium,Kent Canal,Loup Public Power Canal (Upper),Middle Loup No. 1,Middle Loup No. 2,Middle Loup No. 3,Middle Loup No. 4,Mirdan,Ord-North Loup,Sargent Canal,Scotia,Sherman Feeder,Taylor-Ord,Well 1,Well 2,Well 3,Well 4,Well 5,Well 6,Well 7,Well 8,Well 9,Lillian Lake 2440ft,Lillian Lake 2448ft'
insert @scenarios(id) values(1),(5),(4);
----- End Values to Set -----


----- DO NOT CHANGE -----
exec dbo.UpsertModel @imageName, @modelName, @startDateTime, @modflowExeName, @namFileName, @runFileName, @mapRunFileName, @mapSettings, @mapModelArea, @zoneBudgetExeName, @isDoubleSizeHeatMapOutput, @allowablePercentDiscrepancy, @scenarios, @mapZone, @numberOfStressPeriods ,@canalData, @modPathExeName, @simulationFileName;
------