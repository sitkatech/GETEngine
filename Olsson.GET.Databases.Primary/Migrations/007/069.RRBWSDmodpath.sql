...
--Add one value for each scenario that this model supports. 1=Add a Well, 2=Remove a Well, 3=Move a Well, 4=Canal Recharge, 5=Adjust Zone, 6=Retire Additional Wells, 7=Specify Pumping, 8 = ASR, 9 = Adjust Pumping
insert @scenarios(id) values(10);
...
set @numberOfStressPeriods = 1;

--Canal Names
set @canalData = null

--Modpath exe
set @modPathExeName = 'MPath7.exe'

--Modpath simFile name
set @simulationFileName = 'RRBWSD.mpsim'
----- End Values to Set -----
