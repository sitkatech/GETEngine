...
SET @startDateTime = '1997-01-01';
SET @mapSettings = '{zoom:8,center:{lat:40.99411257,lng:-99.75138711},mapTypeId:"terrain"}';
set @numberOfStressPeriods = 804;
set @canalData = 'none'
